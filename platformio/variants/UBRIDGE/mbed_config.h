...
// Configuration parameters
	...
	#define MBED_CONF_SPIF_DRIVER_SPI_MOSI PTE2
#endif
#if !defined(MBED_CONF_SPIF_DRIVER_SPI_CS)
	#define MBED_CONF_SPIF_DRIVER_SPI_CS PTE5
#endif
#if !defined(MBED_CONF_SPIF_DRIVER_SPI_MISO)
	#define MBED_CONF_SPIF_DRIVER_SPI_MISO PTE4
#endif
#if !defined(MBED_CONF_SPIF_DRIVER_SPI_CLK)
	#define MBED_CONF_SPIF_DRIVER_SPI_CLK PTE1
#endif
