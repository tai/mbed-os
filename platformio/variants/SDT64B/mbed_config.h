...
// Configuration parameters
	...
	#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE ETHERNET
#endif
#if !defined(MBED_CONF_KINETIS_EMAC_TX_RING_LEN)
	#define MBED_CONF_KINETIS_EMAC_TX_RING_LEN 8
#endif
#if !defined(MBED_CONF_PPP_CELL_IFACE_AT_PARSER_BUFFER_SIZE)
	#define MBED_CONF_PPP_CELL_IFACE_AT_PARSER_BUFFER_SIZE 256
#endif
#if !defined(MBED_CONF_KINETIS_EMAC_RX_RING_LEN)
	#define MBED_CONF_KINETIS_EMAC_RX_RING_LEN 16
#endif
