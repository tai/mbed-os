...
// Configuration parameters
	...
	#define HFXO_FREQUENCY 50000000
#endif
...
#endif
#if !defined(MBED_CONF_SL_ETH_REFCLK_LOCATION)
	#define MBED_CONF_SL_ETH_REFCLK_LOCATION 5
#endif
#if !defined(LFXO_FREQUENCY)
	#define LFXO_FREQUENCY 32768
#endif
	...
	#define QSPI_FLASH_EN PG13
#endif
#if !defined(MBED_CONF_SL_ETH_RMII_LOCATION)
	#define MBED_CONF_SL_ETH_RMII_LOCATION 1
#endif
	...
	#define MBED_CONF_SL_ETH_PHY_POWER_PIN PI10
#endif
#if !defined(MBED_CONF_SL_ETH_PHY_ENABLE_PIN)
	#define MBED_CONF_SL_ETH_PHY_ENABLE_PIN PH7
#endif
#if !defined(HFXO_FREQUENCY)
	#define HFXO_FREQUENCY 50000000
#endif
	...
	#define EFM_BC_EN PE1
#endif
#if !defined(MBED_CONF_SL_ETH_MDIO_LOCATION)
	#define MBED_CONF_SL_ETH_MDIO_LOCATION 1
#endif
#if !defined(CORE_CLOCK_SOURCE)
	#define CORE_CLOCK_SOURCE HFXO
#endif
