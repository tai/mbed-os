...
// Configuration parameters
	...
	#define MBED_CONF_SD_SPI_MOSI PE_14
#endif
#if !defined(LPTICKER_DELAY_TICKS)
	#define LPTICKER_DELAY_TICKS 1
#endif
#if !defined(MBED_CONF_SD_SPI_MISO)
	#define MBED_CONF_SD_SPI_MISO PE_13
#endif
#if !defined(MBED_CONF_SD_SPI_CS)
	#define MBED_CONF_SD_SPI_CS PG_4
#endif
	...
	#define MBED_CONF_SD_SPI_CLK PE_12
#endif
#if !defined(MBED_CONF_TARGET_LSE_AVAILABLE)
	#define MBED_CONF_TARGET_LSE_AVAILABLE 1
#endif
	...
	#define MBED_CONF_SPIF_DRIVER_SPI_MOSI PE_14
#endif
#if !defined(LPTICKER_DELAY_TICKS)
	#define LPTICKER_DELAY_TICKS 1
#endif
#if !defined(MBED_CONF_SPIF_DRIVER_SPI_MISO)
	#define MBED_CONF_SPIF_DRIVER_SPI_MISO PE_13
#endif
#if !defined(MBED_CONF_SPIF_DRIVER_SPI_CS)
	#define MBED_CONF_SPIF_DRIVER_SPI_CS PE_11
#endif
#if !defined(MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE)
	#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE WIFI
#endif
	...
	#define MBED_CONF_SPIF_DRIVER_SPI_CLK PE_12
#endif
